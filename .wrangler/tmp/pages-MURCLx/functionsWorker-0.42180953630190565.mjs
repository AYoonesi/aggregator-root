...
var buildRegexes = /* @__PURE__ */ __name((startChar, char, flags2 = "") => {
...
var parser = new XMLParser({
  ...
  trimValues: true,
  parseTagValue: false,
  arrayMode: /* @__PURE__ */ __name((tagName) => ["item", "entry", "link", "category"].includes(tagName), "arrayMode")
});
...
// ../.wrangler/tmp/pages-MURCLx/functionsRoutes-0.17734682199016993.mjs
var routes = [
  {
    routePath: "/:path*",
    mountPath: "/",
...
// ../.wrangler/tmp/bundle-6v6HVi/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-6v6HVi/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.42180953630190565.mjs.map
